...
if __name__ == "__main__":
    experiment_id = create_mlflow_experiment(
        ...
        artifact_location="model_registry",
    ...
    with mlflow.start_run(run_name="model_registry") as run:
        ...
        mlflow.sklearn.log_model(artifact_path="rfr_model1", sk_model=RandomForestRegressor(), registered_model_name="RandomForestRegressor")
